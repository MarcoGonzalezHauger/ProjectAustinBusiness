...
//func findInfluencers(offer: TemplateOffer, money: Double, filters: [Bool], completion: @escaping (TemplateOffer) -> ()) {
...
//				if user.categories?.contains(cat) {
//					inList = true
//				}
//			}
//            for gender in offer.genders {
//				if let userGender: Gender = user.gender {
