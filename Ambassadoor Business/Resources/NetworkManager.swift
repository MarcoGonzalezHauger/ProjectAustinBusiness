...
//                let dataString = NSString(data: data!, encoding: String.Encoding.utf8.rawValue)
    ...
    func sendNotificationReferralConvey(params: [String: AnyObject]){
        
        let urlString = "https://us-central1-amassadoor.cloudfunctions.net/" + "sendNotificationReferralConvey"
